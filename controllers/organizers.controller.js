...
const getOrganizerByAcountId = async (req, res) => {
    const { accountId } = req.params;
    try {
        const organizer = await organizerService.getOrganizerByAcountId(parseInt(accountId));
...
const deleteOrganizerById = async (req, res) => {
    ...
    try {
        const deletedOrganizer = await organizerService.deleteOrganizerById(parseInt(id));
        if (deletedOrganizer) {
...
const updateOrganizer = async (req, res) => {
    ...
    try {
        const updatedOrganizer = await organizerService.updateOrganizer(id, updates);
